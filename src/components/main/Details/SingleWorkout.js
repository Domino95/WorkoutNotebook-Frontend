...
const SingleWorkout = (props) => {
    ...
    const setWorkoutName = () => {
        if (localStorage.getItem('language') === "POLISH" && props.name === "Unnamed") {
            return words.training_name
        }
        else if (localStorage.getItem('language') === "ENGLISH" && props.name === "Bez nazwy") {
            return words.training_name
        }
    ...
    return (
        ...
        <NavLink className="link" to={{
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                height="35" viewBox="0 0 24 24" width="35" fill="#ffd901" >
